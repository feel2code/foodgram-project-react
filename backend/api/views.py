...
class SubscribeViewSet(viewsets.ModelViewSet):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        subscribe = get_object_or_404(Subscribe, user__id=user_id, following__id=author_id)
        subscribe.delete()
...
class BaseFavoriteCartViewSet(viewsets.ModelViewSet):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        user_id = request.user.id
        object = get_object_or_404(self.model, user__id=user_id, recipe__id=recipe_id)
        object.delete()
        return Response(HTTPStatus.NO_CONTENT)
